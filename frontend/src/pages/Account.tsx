    ...
    <div className='min-h-screen bg-gray-50 px-4 py-6'>
      <div className='mx-auto max-w-md rounded-lg bg-white shadow-sm '>
          ...
          <div className="divide-y">
            <div className="flex items-center cursor-pointer gap-5 p-5 hover:bg-gray-50" onClick={()=>navigate("/Orders")}>
              <BiPackage className='h-5 w-5 text-red-500'/>
              <span className='font-medium'>Your Orders</span>
            </div>
            <div className="flex items-center cursor-pointer gap-5 p-5 hover:bg-gray-50" onClick={()=>navigate("/Address")}>
              <BiMapPin className='h-5 w-5 text-red-500'/>
              <span className='font-medium'>Address</span>
            </div>
            <div className="flex items-center cursor-pointer gap-5 p-5 hover:bg-gray-50" onClick={logoutHandler}>
