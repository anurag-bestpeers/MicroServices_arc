  ...
  return (
    <div className='w-full bg-white shadow-sm'>
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3">
          <Link to={"/"} className='text-2xl font-bold text-[#e23744] cursor-pointer'>Zomato</Link>
          <div className='flex items-center gap-4'>
            <Link to={"/cart"} className='relative'>
            <CgShoppingCart className='w-6 h-6 text-[#e23744]'/>
            ...
            </Link>
            {
              ...
              <Link to={"/"} className='font-medium text-[#e23744] '>Login</Link>
            }
          </div>
      </div>
      {/* search-bar */}
        ...
        isHomePage && <div className='border-t px-4 py-3'>
          <div className='mx-auto flex max-w-7xl items-center rounded-lg border shadow-sm'>
              ...
              <div className='flex flex-1 items-center gap-2 px-3'>
                <BiSearch className='h-4 w-5 text-gray-400'/>
